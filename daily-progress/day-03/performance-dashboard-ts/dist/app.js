...
class PerformanceDashboard {
    ...
    initializeElements() {
        ...
        this.promiseAllSettledStatus = document.getElementById("promiseAllSettledStatus");
        this.promiseAllSettledResults = document.getElementById("promiseAllSettledResults");
        this.promiseAllSettledTime = document.getElementById("promiseAllSettledTime");
    ...
    async testPromiseAll() {
        ...
        try {
            ...
            this.log(`Promise.all() failed after ${time}ms: ${error.message}`, "error");
        }
    }
